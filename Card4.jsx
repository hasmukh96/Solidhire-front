...
const Card4 = () => {
  return (
    <div className="bg-[#e6ff9e]">
      <div className="flex  md:flex-row flex-col md:py-[100px] py-4 md:mx-[150px] mx-4 md:justify-between justify-center items-center gap-[3rem]">
        <div className=" ">
          <img
            src={form1}
            alt="card2"
            className="rounded-md md:w-[70%] w-full md:mx-0 px-[2rem]"
          />
        </div>
